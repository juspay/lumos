...
> Guidelines for maintaining clean commit history in lumos

## Overview

This document outlines the single commit policy for the lumos repository to ensure a clean, readable, and maintainable git history.
...
```bash
# Via GitHub CLI
gh api repos/juspay-maintainers/lumos \
  --method PATCH \
...
- Issues: https://github.com/juspay/lumos/issues
