...
> Guidelines for setting up branch protection rules for lumos

## Overview

This document outlines the recommended branch protection settings for the lumos repository to ensure code quality and security.
...
gh api repos/juspay-maintainers/lumos/branches/main/protection \
  --method PUT \
